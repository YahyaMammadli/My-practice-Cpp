...
public:
    ...
    void adminAddDish(const string& name, const string& desc, double price)
    {
        try {
            int newId = menu->getAvailableDishes().size() + 1;
...
private:
    ...
    void addNewDish()
    {
        ...
        system.adminAddDish(name, desc, price);
    }
